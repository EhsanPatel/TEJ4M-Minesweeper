...
public class ResourcesRef {
    ...
    private final static Image MAIN_MENU_INST = new ImageIcon(ResourcesRef.class.getResource("images/MainMenu/gameInst.png")).getImage();
    //hovered buttons
    ...
    private final static Image MAIN_MENU_INST_HOVER = new ImageIcon(ResourcesRef.class.getResource("images/MainMenu/hoverInst.png")).getImage();
    //bordered buttons
